                        ...
                        <div className="js-current-details">
                            <div className="js-react-root">
                                <div className="_3Tv3BQB32z31NL">
                                    <h1 className="_2bvXXmbrsPh8Ck">{curWP.name}</h1>
                                    {
                                        curWP.priority === 'private' &&
                                        <span className="_3LRjT6kbhThjbJ">
                                            <span className="nch-icon _3W-26fmi3tFfon j0fswhntKdStWa _1Xh35mJ-vlW3nT">

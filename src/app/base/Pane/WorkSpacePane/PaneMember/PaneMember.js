...
import ModalDeleteWorkSpace from "app/base/Modal/ModalDeleteWorkSpace/ModalDeleteWorkSpace";
...
const PaneMember =  () => 
{
    ...
    let classNameLayout = !isActive ? "org-members-page-layout-list" : "org-members-page-layout-list active"
    return(
        <>
            <div className={classNameLayout}>
                ...
                {
                    isShowRemove && 
                    <ModalDeleteWorkSpace show={isShowRemove} setShow={setShowRemove} email={emailUser} isDeleteWP={false}/>
                }
